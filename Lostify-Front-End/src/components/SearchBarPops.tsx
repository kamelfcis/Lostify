...
interface SearchBarProps {
  ...
  onImageUpload?: (file: File) => void; // Optional callback for image search

  onSearch: () => void; // Triggered on form submit
}
...
const SearchBar: React.FC<SearchBarProps> = ({
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    // Call parent handler for search with current filters
    onSearch();
    // Optional: navigate with query params
