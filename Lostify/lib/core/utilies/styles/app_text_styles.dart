import 'package:lostify/core/helper/get_responsive_font_size.dart';
...
class AppTextStyles {
  ...
  static TextStyle title14White500 = TextStyle(
    color: Colors.white,
    fontWeight: FontWeight.w500,
    fontSize: getResponsiveFontSize(fontSize: 14),
  );
  static TextStyle title14Black500 = TextStyle(
    color: Colors.black,
    fontWeight: FontWeight.w500,
    fontSize: getResponsiveFontSize(fontSize: 14),
  );
  ...
  static TextStyle title12WhiteColorW500 = TextStyle(
    color: Colors.white,
    fontSize: getResponsiveFontSize(fontSize: 12),
    fontWeight: FontWeight.w500,
  );
